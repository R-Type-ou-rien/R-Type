...
void EnemySpawnSystem::update(Registry& registry, system_context context) {
    ...
    float windowWidth =
        context.window.has_value() ? static_cast<float>(context.window.value().get().getSize().x) : 800.0f;
...
void EnemySpawnSystem::spawnBoss(Registry& registry, system_context context) {
    ...
    float windowWidth =
        context.window.has_value() ? static_cast<float>(context.window.value().get().getSize().x) : 800.0f;
    float windowHeight =
        context.window.has_value() ? static_cast<float>(context.window.value().get().getSize().y) : 600.0f;
