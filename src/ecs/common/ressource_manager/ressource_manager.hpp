...
class ResourceManager {
    ...
    public:
        ...
        bool has_resource(const handle_t<Resource> handle)
        {
            return _ressourceStorage.has(handle);
        }
        ...
        std::vector<Resource> get_all_resources()
        {
            return _ressourceStorage.get_data_list();
        }
