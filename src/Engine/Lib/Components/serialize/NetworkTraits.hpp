...
namespace serialize {
    ...
    struct ComponentTraits {
        static T deserialize(const std::vector<uint8_t>& buffer, size_t& offset, ResourceManager<TextureAsset>& resourceManager) {
    ...
    struct ComponentTraits<PatternComponent> {
        static PatternComponent deserialize(const std::vector<uint8_t>& buffer, size_t& offset, ResourceManager<TextureAsset>&) {
    ...
    struct ComponentTraits<transform_component_s> {
        static transform_component_s deserialize(const std::vector<uint8_t>& buffer, size_t& offset, ResourceManager<TextureAsset>&) {
    ...
    struct ComponentTraits<BoxCollisionComponent> {
        static BoxCollisionComponent deserialize(const std::vector<uint8_t>& buffer, size_t& offset, ResourceManager<TextureAsset>&) {
    ...
    struct ComponentTraits<TagComponent> {
        static TagComponent deserialize(const std::vector<uint8_t>& buffer, size_t& offset, ResourceManager<TextureAsset>&) {
    ...
    struct ComponentTraits<TextComponent> {
        static TextComponent deserialize(const std::vector<uint8_t>& buffer, size_t& offset, ResourceManager<TextureAsset>&) {
    ...
    struct ComponentTraits<sprite2D_component_s> {
        static sprite2D_component_s deserialize(const std::vector<uint8_t>& buffer, size_t& offset, ResourceManager<TextureAsset>& resourceManager) {
    ...
    struct ComponentTraits<BackgroundComponent> {
        static BackgroundComponent deserialize(const std::vector<uint8_t>& buffer, size_t& offset, ResourceManager<TextureAsset>& resourceManager) {
