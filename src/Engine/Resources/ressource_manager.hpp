...
//    public:
//     handle_t<Resource> load(const std::string& ressource_name, const Resource& ressource_data) {
...
//     bool has(const handle_t<Resource> handle) { return _ressourceStorage.has(handle); }
